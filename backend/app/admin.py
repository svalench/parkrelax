...
admin.add_view(ModelView(Booking, icon="fa fa-calendar-check", label="Bookings", identity="bookings"))
...
admin.add_view(ModelView(AccommodationType, icon="fa fa-bed", label="Accommodation Types", identity="accommodation"))
